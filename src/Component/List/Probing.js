        ...
        return (
          <>
            <div className='intro'>
              ...
              <br />
              <p>
              Quadratic probing is an open addressing scheme which operates 
              by taking the original hash index <br/>and adding successive square
              of c (where, c is the number of collisions occured )until an open slot is found.
              </p>
              <br />
              <br />
              <h2 className='sub-heading'> Quadratic Probing Demonstration </h2>
              <img className='image' src="/Sources/prob.jpeg"></img>
              <br />
            </div>
          </>
        );
