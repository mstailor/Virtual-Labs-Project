        ...
        <div className="app-container">
          ...
          <div className={`main-content ${isSidebarVisible ? '' : 'full-width'}`}>
            ...
            <div className="intro-paragraph">
              <p>
                The Virtual Lab for Data Structures aims to create an interactive environment where students can explore data structures. It complements lectures, reading materials, and programming labs in three key ways:
              </p>
              <ol>
                <li>Providing visual animations of data structures.</li>
                <li>Allowing students to execute algorithms interactively within these structures.</li>
                <li>Enabling students to calculate the cost of using various data structures with different algorithms interactively.</li>
              </ol>
            </div>
          </div>
        </div>
